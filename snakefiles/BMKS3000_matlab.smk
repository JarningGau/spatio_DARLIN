...
rule call_allele:
    ...
    shell:
        ...
        bash {script_dir}/annotate_allele_matlab.sh {CARLIN_dir} $input_dir $output_dir_path {wildcards.sample}_{wildcards.locus} {cfg_type} {template} $read_cutoff_UMI_override $read_cutoff_CB_override
        """
